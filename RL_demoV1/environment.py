...
class Env():
    ...
    def reset(self):
        ...
        self.IRB120_Uid = p.loadURDF("AIN4745_RL_For_Industrial_Robotics/urdf/ABB_with_gripper.urdf", useFixedBase=True)
        self.WorkCell = p.loadURDF('AIN4745_RL_For_Industrial_Robotics/urdf/workcell_new.urdf', useFixedBase=True)
        self.numberJoints = p.getNumJoints(self.IRB120_Uid) - 1  # extract end effector joint
        # print("Nunber of Joints:", self.numberJoints)
        self.cable = p.loadURDF('AIN4745_RL_For_Industrial_Robotics/urdf/cable.urdf',basePosition=[0.03, 0.35, 0.0825])
